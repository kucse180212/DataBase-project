    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h4 class="display-6">CLick below to check the Bus you are serving..</h4>
            <a href="{{route ( 'check_buses', [$user->email] )}}" class="btn btn-dark btn-xl rounded-pill mt-5">Click here</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="p-5">
            <h2 class="display-4">Click below to add your bus time schudle </h2>
            <a href="{{route ( 'add_buses', [$user->email] )}}" class="btn btn-success btn-xl rounded-pill mt-5">Click here</a>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">Click below to Register Your Company</h2>

          <a href="{{route ( 'add_company', [$user->email] )}}" class="btn btn-primary btn-xl rounded-pill mt-5">{{$user->email}}</a>
